...
- If the context contains Slack messages, commands, or activity logs — describe ALL of it as what happened. Do NOT say "I'm not aware" if there is any content in the context.
